...
function dTree(objName, path) {
	...
	this.icon = {root:path + "img/base.gif", folder:path + "img/folder.gif", folderOpen:path + "img/folderopen.gif", node:path + "img/page.gif", empty:path + "img/empty.gif", line:path + "img/line.gif", join:path + "img/join.gif", joinBottom:path + "img/joinbottom.gif", plus:path + "img/plus.gif", plusBottom:path + "img/plusbottom.gif", minus:path + "img/minus.gif", minusBottom:path + "img/minusbottom.gif", nlPlus:path + "img/nolines_plus.gif", nlMinus:path + "img/nolines_minus.gif"};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function (node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		str += "<img align=\"absmiddle\" style=\"border:0\" id=\"i" + this.obj + nodeId + "\" src=\"" + ((node._io) ? node.iconOpen : node.icon) + "\" alt=\"\" />";
	}
	if (node.url) {
...
dTree.prototype.indent = function (node, nodeId) {
	...
	if (this.root.id != node.pid) {
		for (var n = 0; n < this.aIndent.length; n++) {
			str += "<img align=\"absmiddle\" style=\"border:0\" src=\"" + ((this.aIndent[n] == 1 && this.config.useLines) ? this.icon.line : this.icon.empty) + "\" alt=\"\" />";
		}
		(node._ls) ? this.aIndent.push(0) : this.aIndent.push(1);
		if (node._hc) {
			str += "<a href=\"javascript: " + this.obj + ".o(" + nodeId + ");\"><img align=\"absmiddle\" style=\"border:0\" id=\"j" + this.obj + nodeId + "\" src=\"";
			...
			str += "<img align=\"absmiddle\" style=\"border:0\" src=\"" + ((this.config.useLines) ? ((node._ls) ? this.icon.joinBottom : this.icon.join) : this.icon.empty) + "\" alt=\"\" />";
		}
	}
	return str;
};
