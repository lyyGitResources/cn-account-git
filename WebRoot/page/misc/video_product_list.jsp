	...
	<body>
		...
		<div class="tabMenu">
			<ul>
				...
				<li class="current"><span onclick="ListTable.url='/video/video_list.do';tabMenu(4,{videoType:'Product'})"><s:text name="video.productVideoCount"/>[<s:property value="result.productVideoCount"/>]</span></li>
				<li><span onclick="ListTable.url='/video/video_list.do';tabMenu(5,{videoType:'Menu'})"><s:text name="video.menuVideoCount"/>[<s:property value="result.menuVideoCount"/>]</span></li>
			</ul>
		</div>
