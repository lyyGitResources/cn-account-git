		...
		<div id="header">
		    <div class="topTips">
		        <ul class="quickLink">
		            ...
		            <li><a href="<%=sysBase %>/sitemap.html">网站导航</a></li>
		    ...
		    <div class="topToolBar">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="h1">
					<tr>
						<td valign="bottom">
							<s:if test="result.headDescription != null"><s:property value="result.headDescription"/></s:if>
							<s:elseif test="inquiry != null">海商网询盘发送，询盘信息，贸易询盘，买卖信息，贸易机会，商业信息</s:elseif>
							<s:elseif test="basketItemList != null">海商网询盘篮，购物篮，贸易机会，商业信息，供求信息，采购商，供应商</s:elseif>
						</td>
					</tr>
				</table>
...
<!--						<div class="formBox formBox3"><a href="#">热门产品</a></div>-->
		    ...
		    <div class="hiMenu">
		        ...
		        <div class="r"></div>
		        <ul>
		            <li class="current"><a href="<%=sysBase %>">首页</a></li>
